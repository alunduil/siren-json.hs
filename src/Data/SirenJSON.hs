...
import Data.Aeson (FromJSON (parseJSON), Object, ToJSON (toJSON), Value (Object, String), object, withObject, withText, (.!=), (.:), (.:?), (.=))
...
import qualified Data.Map.Strict as Map (Map, empty, null)
...
data Entity = Entity
  ...
  {- ^ 'Entity' state as key-value pairs---we
