...
- CI: `.github/workflows/ci.yml` runs pre-commit. Workflow files are named for
...
- CI (legacy): `.travis.yml`, generated by haskell-ci (`make_travis_yml_2.hs`)
  — edit the generator, not the file. Whether Travis still runs is unverified;
